...
/*
	Notes by Paul Boersma:
	- the "Monty" mentioned above is Christopher Montgomery.
	- we made trivial modifications for Vokaturi:
		- replaced all int with long;
		- replaced all float with double;
		- added `const` to array parameters wherever possible;
	- this version is still in the public domain.
*/

static void drfti1 (long n, double *wa, long *ifac)
{
...
static void dradf2 (long ido, long l1, const double *cc, double *ch, const double *wa1)
{
	long i, k;
	double ti2, tr2;
...
static void dradf4 (long ido, long l1, const double *cc, double *ch, const double *wa1,
	const double *wa2, const double *wa3)
{
...
static void dradfg (long ido, long ip, long l1, long idl1, double *cc, double *c1,
	double *c2, double *ch, double *ch2, const double *wa)
{
	static double tpi = 6.28318530717958647692528676655900577;
...
static void drftf1 (long n, double * c, double * ch, const double * wa, const long *ifac)
{
	long i, k1, l1, l2;
	long na, kh, nf;
...
static void dradb2 (long ido, long l1, const double *cc, double *ch, const double *wa1)
{
	long i, k, t0, t1, t2, t3, t4, t5, t6;
	double ti2, tr2;
...
static void dradb3 (long ido, long l1, const double *cc, double *ch, const double *wa1,
	const double *wa2)
{
...
static void dradb4 (long ido, long l1, const double *cc, double *ch, const double *wa1,
	const double *wa2, const double *wa3)
{
...
static void dradbg (long ido, long ip, long l1, long idl1, const double *cc, double *c1,
	double *c2, double *ch, double *ch2, const double *wa)
{
	static double tpi = 6.28318530717958647692528676655900577;
...
static void drftb1 (long n, double *c, double *ch, const double *wa, const long *ifac)
{
	long i, k1, l1, l2;
	long na;
